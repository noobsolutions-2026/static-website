...
| [AI System & Use-Case Inventory](governance/ai-system-inventory.md) | `ai-system-inventory` | The living register of every AI system and use case in an organisation — because you cannot govern, risk-tier, or secure what you cannot see. | ai-governance, inventory, registry, discovery, controls | 2026-06-20 |
...
| governance/ai-system-inventory | governance/ai-governance | The inventory is the "list" pillar of the minimum viable program — you cannot govern what you cannot see |
| governance/ai-system-inventory | governance/ai-acceptable-use-policy | The AUP's approved-tools register is drawn from, and feeds, the inventory |

---

*Total: 11 pages · 3 domains active · 3 domains pending*  
